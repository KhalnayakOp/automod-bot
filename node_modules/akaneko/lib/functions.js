...
module.exports = {
    ...
    nsfw: {
        ...
        foot: function () {
            return akansfw.feet(); // Alias of Feet
        },
        pussy: function () {
            return akansfw.pussy();
        },
        vagina: function () {
            return akansfw.pussy(); // Alias of Pussy
        },
        uglyBastard: function () {
            return akansfw.uglyBastard();
        },
        uniform: function () {
            return akansfw.uniform();
        },
        gangbang: function () {
            return akansfw.gangbang();
        },
        sharing: function () {
            return akansfw.gangbang(); // Alias of Gangbang
        }
